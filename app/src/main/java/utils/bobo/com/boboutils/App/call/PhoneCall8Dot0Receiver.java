 ...
 */
public class PhoneCall8Dot0Receiver extends BroadcastReceiver {
    private int lastCallState  = TelephonyManager.CALL_STATE_IDLE;
    private boolean isIncoming = false;
    private static String contactNum;
    Intent AudioRecorder8Dot0Service;


    public PhoneCall8Dot0Receiver() {
    }
    ...
    protected void onIncomingCallStarted(Context context,String number){
        ...
        context.startService(new Intent(context,AudioRecorder8Dot0Service.class));
    ...
    protected void onIncomingCallEnded(Context context,String number){
        ...
        context.stopService(new Intent(context, AudioRecorder8Dot0Service.class));
    }
