...
public class CallAudioRecordActivity extends Activity implements View.OnClickListener {
    private static final String TAG = "CallAudioRecordActivity";
    private BroadcastReceiver mBroadcastReceiver = new PhoneCallReceiver();
    @Override
