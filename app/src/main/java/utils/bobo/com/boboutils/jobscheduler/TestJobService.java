...
public class TestJobService extends JobService {
    ...
    /**
     * When the app's JobSchedulerAndThreadAndAsyncTask is created, it starts this service. This is so that the
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        m.what = JobSchedulerAndThreadAndAsyncTask.MSG_SERVICE_OBJ;
        m.obj = this;
        try {
            callback.send(m);
    ...
    JobSchedulerAndThreadAndAsyncTask mActivity;
    private final LinkedList<JobParameters> jobParamsMap = new LinkedList<JobParameters>();

    public void setUiCallback(JobSchedulerAndThreadAndAsyncTask activity) {
        mActivity = activity;
    }
